...
function getColorPopulation(d) {
  return d > 7000 ? '#54278f' : d > 5000 ? '#756bb1' : d > 3000 ? '#9e9ac8' : d > 800 ? '#cbc9e2' : '#f2f0f7';
}
...
var geojsonPark = new L.GeoJSON.AJAX(_parks.default, {
  style: parkStyle
});
...
info.update = function (props) {
  this._div.innerHTML = '<h4>Population Density</h4>' + (props ? '<b>' + props.NAMELSAD10 + '</b><br />' + props.population_density.toFixed(1) + ' people / mi<sup>2</sup>' : 'Hover over a census tract');
};
...
geojsonPopulation = new L.GeoJSON.AJAX(_demographics.default, {
...
legend.onAdd = function (map) {
  ...
  for (var i = 0; i < grades.length; i++) {
    ...
    div.innerHTML += '<i style="background:' + getColorPopulation(grades[i] + 1) + '"></i> ' + grades[i] + (grades[i + 1] ? '&ndash;' + grades[i + 1] + '<br>' : '+');
  }
...
},{"./geojson_files/parks.geojson":"geojson_files/parks.geojson","./geojson_files/demographics.geojson":"geojson_files/demographics.geojson"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
